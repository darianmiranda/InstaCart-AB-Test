...
This project evaluated whether reminder notifications encouraging users to reorder previously purchased products increased overall order activity on InstaCart. Using an end to end A/B testing framework in R, the analysis uses a randomized experiment to measure the causal effect of reminder notifications on customer purchasing behavior.
